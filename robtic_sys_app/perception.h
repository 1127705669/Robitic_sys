...
class Perception{
 ...
 private:
  ...
  const unsigned long black_line_threshold_1_ = 2000;
  const unsigned long black_line_threshold_2_ = 2000;
  const unsigned long black_line_threshold_3_ = 2000;
  const unsigned long black_line_threshold_4_ = 2000;
  const unsigned long black_line_threshold_5_ = 2000;
